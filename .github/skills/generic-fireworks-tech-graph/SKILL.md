---
name: generic-fireworks-tech-graph
description: >-
...
Do not pass `@yizhiyanhua-ai/generic-fireworks-tech-graph` directly to `skills add`, because the CLI expects a GitHub or local repository source.
