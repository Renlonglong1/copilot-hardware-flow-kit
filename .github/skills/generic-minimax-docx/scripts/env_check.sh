#!/usr/bin/env bash
# generic-minimax-docx Quick Environment Check
# Cross-platform: macOS, Linux, WSL, Git Bash
# Run this BEFORE any generic-minimax-docx operation. Use setup.sh for initial installation.
set -euo pipefail
...
echo "=== generic-minimax-docx Environment Check ==="
echo ""
