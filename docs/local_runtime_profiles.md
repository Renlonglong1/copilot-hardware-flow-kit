...
This deployed machine has local profiles for the validated DBGSH05 flow and LAN UI.
...
Existing `hardware-flow.dbgsh05.json` and lab-inventory entries are validated lab
